    ...
    return(
        <div>
            ...
            <a className="flex-row" href="https://github.com/hariprasd/spot">
                <p className="underline font-normal pt-6 px-9 text-xs text-right text-gray-500">Github Link ↗︎</p>
            </a>
            ...
            <img className="mx-auto p-6 items-center w-1/3" src={w1} alt="Working1"></img>
            <p className="m-6 px-3 text-sm ">
            ...
            <img className="mx-auto p-6 items-center w-1/2" src={w2} alt="Working2"></img>
